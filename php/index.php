...
<body>
    ...
    <main>
        ...
        <div class="JScode_and_text">
            ...
            <img width="500px" src="../assets/images/editor.webp" alt="">
        </div>
        ...
        <div class="sponsoried">
            ...
            <img width="200px" height="200px" src="../assets/images/logo2.png" alt=""> <br>
    ...
    <script>
        /*check validation */
        window.addEventListener('scroll', validatAnimation());

        function validatAnimation() {

        }
        /*end validation block code*/
    </script>
</body>
